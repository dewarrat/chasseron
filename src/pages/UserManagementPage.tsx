...
import { Users, Search, Shield, Code2, Briefcase, UserX, UserCheck, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500 ml-9">Manage user accounts and access</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50">
                ...
                <th className="px-5 py-3 text-left font-medium text-slate-500 w-32">Role</th>
                ...
                <th className="px-5 py-3 text-right font-medium text-slate-500 w-28">Actions</th>
              </tr>
            </thead>
                      ...
                      {!isSelf && (
                        <>
                          {p.is_active ? (
                            ...
                            <button
                              onClick={() => { setSelectedUser(p); setShowReactivate(true); }}
      ...
      <Modal open={showReactivate} onClose={() => { setShowReactivate(false); setSelectedUser(null); }} title="Reactivate User">
        <div className="space-y-4">
          <p className="text-sm text-slate-600">
            Are you sure you want to reactivate <span className="font-semibold">{selectedUser?.full_name || selectedUser?.email}</span>?
          </p>
          <p className="text-sm text-slate-500">
            This will restore their access to the system. They will appear in team lists and be available for ticket assignments again.
          </p>
          <div className="flex justify-end gap-3 pt-2">
            <button
